...
impl Translator {
    ...
    fn create_en_dict() -> HashMap<&'static str, &'static str> {
        ...
        map.insert("tab.disks", "4:Disks");
        map.insert("tab.network", "5:Network");
        map.insert("tab.gpu", "6:GPU");
        map.insert("tab.system", "7:System");
        map.insert("tab.services", "8:Services");
        map.insert("tab.logs", "9:Logs");
        map.insert("tab.config", "0:Config");
        ...
        map.insert("help.main", "Quit: q | Tabs: 1-9,0 | Navigate: ↑↓ | Enter: Details | Pause: p | Search: /");
    ...
    fn create_tr_dict() -> HashMap<&'static str, &'static str> {
        ...
        map.insert("tab.cpu", "3:CPU");
        map.insert("tab.disks", "4:Diskler");
        map.insert("tab.network", "5:Ağ");
        map.insert("tab.gpu", "6:GPU");
        map.insert("tab.system", "7:Sistem");
        map.insert("tab.services", "8:Hizmetler");
        map.insert("tab.logs", "9:Günlükler");
        map.insert("tab.config", "0:Yapılandırma");
        ...
        map.insert("help.main", "Çık: q | Sekmeler: 1-9,0 | Gezin: ↑↓ | Enter: Detaylar | Duraklat: p | Ara: /");
        ...
        map.insert("status.sleeping", "Uyuyor");
        map.insert("status.zombie", "Hayalet");
